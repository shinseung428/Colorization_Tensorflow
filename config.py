...
#folder path setting
parser.add_argument('--data', dest='data', default='./models/data/', help='image datapath')
...
parser.add_argument('--input_width', dest='input_width', default=63, help='input image width')
