...
parser.add_argument('--input_width', dest='input_width', default=95, help='input image width')
parser.add_argument('--input_height', dest='input_height', default=95, help='input image height')
...
parser.add_argument('--batch_size', dest='batch_size', default=36, help='batch size')
